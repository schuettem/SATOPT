...
if __name__ == "__main__":
    ...
    print(f"Panel ID: {id}")
    panel = panels[id]
    p1, p2, p3 = mesh_vertices[panel[0]], mesh_vertices[panel[1]], mesh_vertices[panel[2]]
    ...
    aoas, areas = compute_aoa_and_area(panels, mesh_vertices, incident_velocity=np.array([-1, 0, 0]))
